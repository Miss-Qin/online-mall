        ...
        <div class="section">
            <div class="wrapper">
                <div class="bg-wrap">
                    ...
                    <!--购物车头部-->
                    <div class="cart-box">
                        <el-form :model="orderForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <div id="orderForm" name="orderForm" url="">
                                ...
                                <div class="form-box address-info">
                                    ...
                                    <el-form-item label="所属地区" prop="checkPass">
                                        <v-distpicker @selected="onSelected" :province="orderForm.area.province.value" :city="orderForm.area.city.value" :area="orderForm.area.area.value"></v-distpicker>
                                    </el-form-item>
                                ...
                                <ul class="item-box clearfix">
                                    ...
                                    <li>
                                        ...
                                        <el-radio @change="expressChange(8)" v-model="orderForm.express_id" label="3">天天快递(8元)</el-radio>
                                    </li>
                                </ul>
                                <h2 class="slide-tit">
                                    <span>4、商品清单</span>
                                ...
                                <table width="100%" border="0" align="center" cellpadding="8" cellspacing="0" class="cart-table">
                                    <tbody>
                                        ...
                                        <tr v-for="(item, index) in selProduct" :key="index">
                                            <td width="68">
                                    ...
                                    <div class="left-box">
                                        <dl>
                                            <el-form-item label="订单备注(100字符以内)" prop="message">
                                                <el-input type="textarea" name="message" v-model="orderForm.message" class="input" style="height:35px;"></el-input>
                                            </el-form-item>
                                        </dl>
                                    </div>
                                    <div class="right-box">
  ...
  created() {
    ...
    this.$axios
      ...
      .then(response => {
        ...
        this.selProduct = response.data.message;
      });
  },
  methods: {
    onSelected(data) {
    ...
    submitOrder() {
      this.$axios
        ...
        .then(response => {
         ...
         this.$router.push("/submit/" + orderid);
          this.selProduct.forEach(v => {
