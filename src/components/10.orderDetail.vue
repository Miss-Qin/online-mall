<template>
    <div class="center">
                                    ...
                                    <div class="center-nav">
                                        <ul>
                                            <li>
                                                ...
                                                <div class="list">
                                                    <p>
                                                        <router-link to="/orderList">交易订单</router-link>
                                                    </p>
                                                </div>
                                            </li>
                                            <li>
                                    ...
                                    <div class="order-progress">
                                        <ul>
                                            ...
                                            <li :class="{active:orderinfo.status>3}">
                                                ...
                                                <div class="info">{{orderinfo.payment_time | capitalize('YYYY-MM-DD hh:mm:ss')}}</div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link :to="'/submit/'+orderinfo.id" v-if="orderinfo.status==1" href="#/site/goods/payment/12" class="btn-pay">去付款</router-link>
                                                <a v-if="orderinfo.status>1&&orderinfo.status<4" @click="confirmOrder" class="btn-pay">签收</a>
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
                                            <dt>订单状态：</dt>
        ...
        <Modal title="提示" v-model="isShow" :styles="{top: '20px'}" @on-ok="comfirmAgain">
            <p>点击签收后,资金将会交付于卖家,请确认是否收到商品?</p>
        </Modal>
    </div>
</template>
