<template>
    <div>
        ...
        <div class="section" v-show="groupData" v-for="item in groupData" :key="item.level1cateid">
            <div class="main-tit">
                <h2>{{item.catetitle}}</h2>
                <p>
                    <a href="/goods/43.html" v-for="itemSon in item.datas" :key="itemSon.artID">{{itemSon.cateTitle}}</a>
                ...
                <div class="wrap-box">
                    <ul class="img-list">
                        <li v-for="itemSon in item.datas" :key="itemSon.artID">
                            <router-link :to='"/detail/"+itemSon.artID' class="">
                                <div class="img-box">
